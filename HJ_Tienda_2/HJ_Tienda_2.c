    ...
    do
    {
        ...
        case 2:
            ...
            imprimirFactura(numa, numb, numc, numd, nume,
                     ...
                     nombre, cedula,subtotal, opcion1, total);
...
void imprimirFactura(float numa, float numb, float numc, float numd, float nume,
                     ...
                     char nombre[], char cedula[],float subtotal, float opcion1, float total)
{
     printf("*********   FACTURA ************\n");
    printf("Nombre: %s\n", nombre);
    printf("Nro. cedula: %s\n", cedula);
